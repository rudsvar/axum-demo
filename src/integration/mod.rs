//! Utilities for performing integration calls.
//!
//! Provides utilities such as [`LogClient`] and [`log_client`] for creating
//! pre-configured clients that can log requests.
